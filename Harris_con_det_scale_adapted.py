...
tform = AffineTransform(scale=(1.0, 0.5))
image = warp(image, tform.inverse)

#synthetic image in paint
#image = io.imread("images/synimg.jpg")
#image = rgb2gray(image)
#tform = AffineTransform(scale=(0.6, 1.0))
#image = warp(image, tform.inverse)

# Sheared checkerboard
#tform = AffineTransform(scale=(2.2, 1.3), rotation=1, shear=0.7, translation=(110, 30))
